-- [nfnl] modules/treesitter.fnl
 ...
 local function _3_(_, opts) vim.opt.rtp:prepend(_G["tree-sitter-path"])

 local ts = require("nvim-treesitter.configs")
 return ts.setup(opts) end return plug("nvim-treesitter", {opts = {highlight = {enable = true}}, config = _3_})

-- [nfnl] init.fnl
 ...
 local function _11_() return Snacks.picker.neorg() end plug("snacks.nvim", {keys = {{"<leader>gg", _6_, desc = "Lazygit"}, {"<leader><space>", _7_}, {"<leader>fg", _8_}, {"<leader>,", _9_}, {"<leader>ld", _10_}, {"<leader>no", _11_}}, priority = 1000, opts = {lazygit = {enabled = true}, picker = {sources = {neorg = {finder = neorg_finder}}}}, lazy = false})
